...
public final class RepositoryListQuery: GraphQLQuery {
  ...
  public struct Data: GraphQLSelectionSet {
    ...
    public static var selections: [GraphQLSelection] {
      return [
        GraphQLField("search", arguments: ["query": "topic:ios", "type": "REPOSITORY", "last": 50], type: .nonNull(.object(Search.selections))),
      ]
    }
    ...
    public struct Search: GraphQLSelectionSet {
      ...
      public struct Edge: GraphQLSelectionSet {
        ...
        public struct Node: GraphQLSelectionSet {
          ...
          public static func makeRepository(id: GraphQLID, name: String, stargazerCount: Int) -> Node {
            return Node(unsafeResultMap: ["__typename": "Repository", "id": id, "name": name, "stargazerCount": stargazerCount])
          }
          ...
          public struct AsRepository: GraphQLSelectionSet {
            ...
            public init(id: GraphQLID, name: String, stargazerCount: Int) {
              self.init(unsafeResultMap: ["__typename": "Repository", "id": id, "name": name, "stargazerCount": stargazerCount])
            }
